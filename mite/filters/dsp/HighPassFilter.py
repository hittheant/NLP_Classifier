...
class HighPassFilter(AbstractBaseFilter):
    """ A Python implementation of a Butterworth highpass filter """
    ...
    def filter(self, x):
        """
        Highpass filters the input data
...
if __name__ == '__main__':
    ...
    hpf = HighPassFilter(cutoff = cutoff, fs = fs, order = order)
    w, h = freqz( hpf._HighPassFilter__butter[0], hpf._HighPassFilter__butter[1], worN = 8000 )
    plt.subplot( 2, 1, 1 )
