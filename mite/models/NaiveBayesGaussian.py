...
class NaiveBayesGaussian(AbstractBaseModel):
    """ Python implementation of naive Bayes model """
    def __init__(self, X, y, nb_priors = None):
        """
        Constructor
        ...
        y : numpy.ndarray (n_samples,)
            Training labels
        nb_priors : iterable of floats
            Prior probabilities for each class [must sum to 1]
        regressor : bool
        ...
        -------
        obj
            A NaiveBayesGaussian model
        """
        from sklearn.naive_bayes import GaussianNB
        self.__model = GaussianNB( priors = nb_priors )
